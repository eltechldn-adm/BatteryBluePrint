...
**Scenario:** A hypothetical homeowner in Bristol installs a 5 kW solar array with a GivEnergy 9.5 kWh hybrid inverter (DC-coupled). Their roof has 20 panels producing a Voc of 400V at 25°C. In February 2026, an overnight temperature of -6°C causes panel Voc to rise to 447V — within the inverter's 450V DC input maximum, but close enough to trigger transient overvoltage protection on sunrise. *This is a modelled scenario illustrating market economics, not a documented outcome.*
