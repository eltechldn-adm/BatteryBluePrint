...
|----------|--------|--------|
| **Highest Efficiency** | DC Coupled | 97-98% efficiency, captures clipped solar, simpler architecture |
...
> **Highest Efficiency:** 97-98% round-trip efficiency and clipping capture deliver 3-5% more annual production.
...
> **Maximum Flexibility:** Works with any existing solar system. No inverter replacement required.
...
**Optimal Architecture:** DC Coupled
...
**Optimal Architecture:** AC Coupled
...
*   [**How Solar Batteries Work**](/guide)
...
## Illustrative Fault Scenario

**Scenario:** A hypothetical homeowner in Bristol installs a 5 kW solar array with a 9.5 kWh hybrid inverter (DC-coupled). Their roof has 20 panels producing a Voc of 400V at 25°C. In this hypothetical configuration, an overnight temperature of -6°C would cause panel Voc to rise to 447V — within the inverter's 450V DC input maximum, but close enough to trigger transient overvoltage protection on sunrise.

**Modelled behaviour:** Under these conditions, the system would fail to start solar generation until ambient temperatures rose (e.g., 10:15 AM). The calculated consequence of this transient overvoltage fault is an estimated 4.2 kWh of lost generation over a three-day cold spell.

**Resolution:** A competent installer would prevent or resolve this by modifying the string configuration — for example, removing two panels from the series string and rewiring them in parallel. This drops the modelled Voc at -10°C to 411V, providing adequate headroom for the inverter to perform correctly throughout the winter.
...
1. **IEEE Standard 1547** — Interconnection and Interoperability of Distributed Energy Resources, governing AC coupling interfaces: [standards.ieee.org](https://standards.ieee.org/)
1. **NEC Article 706** — National Electrical Code requirements for Energy Storage Systems: [nfpa.org/70](https://www.nfpa.org/codes-and-standards/all-codes-and-standards/list-of-codes-and-standards/detail?code=70)
1. **SolarEdge DC-Coupled Architecture** — Technical whitepapers on DC coupling efficiency: [solaredge.com](https://www.solaredge.com/)
1. **Enphase AC-Coupled Storage** — Engineering briefs on microinverter-based AC coupling: [enphase.com](https://enphase.com/)
