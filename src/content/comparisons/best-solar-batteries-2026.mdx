...
- **Continuous Output (kW):** The sustained power the battery can provide.
...
|----------|--------|--------|
| **Analysis Category:** | Tesla Powerwall 3 | 11.5 kW continuous power, integrated inverter, Analysis Category: |
...
> **Analysis Category:** 11.5 kW continuous makes this the only battery that can start central AC units without soft starters.
...
> **Analysis Category:** The only battery with seamless generator integration. Critical for multi-week outages.
...
> **Analysis Category:** 15-year warranty and unlimited stacking make this the most future-proof choice.
...
> **Analysis Category:** UK pricing at £442/kWh vs £481/kWh for Tesla delivers 6-year payback.
...
**Analysis Category:** Tesla Powerwall 3
...
**Analysis Category:** FranklinWH aPower
...
**Analysis Category:** Enphase IQ Battery 5P
...
**Analysis Category:** GivEnergy All-In-One
...
*   **If I lived in Florida (Hurricanes):** Analysis Category: **FranklinWH**. Period. The ability to integrate a gas generator seamlessly is non-negotiable for multi-week power outages.
*   **If I lived in California (NEM 3.0):** Analysis Category: **Tesla Powerwall 3**. The financial math relies on perfect software arbitrage to buy/sell at the right millisecond. Tesla's software is the best at this.
*   **If I lived in the UK:** Analysis Category: **GivEnergy**. The price point allows me to ROI in 6 years, whereas a Powerwall might take 9. Money talks.
...
*   [**Battery Costs 2026**](/markets/us-solar-battery-cost-2026)
...
At $14,000 gross installed cost (note: the Section 25D federal ITC expired for 2026 purchases), the payback period is approximately 18 years — longer than many initial estimates because off-peak top-up costs and demand charges were not modelled at point of sale.

**Lesson:** California NEM 3.0 arbitrage economics are real but sensitive to accurate modelling. Use the battery sizing calculator to model your specific tariff, and consult our [solar battery cost guide](/markets/us-solar-battery-cost-2026) before accepting an installer's savings projection at face value.
...
- [How to Choose the Right Solar Battery](/how-to/how-to-choose-the-right-solar-battery) — Decision framework for narrowing your shortlist
- [UK Incentives for Solar Battery Storage](/incentives/uk-solar-battery-incentives-grants-2026) — How incentives affect the financial case for each brand
...
1. **Tesla Powerwall 3 Datasheet** — Official specifications from Tesla, including continuous power output and LFP chemistry confirmation: [tesla.com/powerwall](https://www.tesla.com/powerwall)
2. **Enphase IQ Battery 5P Datasheet** — Enphase technical specifications including round-trip efficiency and warranty terms: [enphase.com/store/batteries](https://enphase.com/store/batteries)
3. **FranklinWH aPower Datasheet** — FranklinWH product specifications and generator integration documentation: [franklinwh.com/apower](https://www.franklinwh.com/apower)
4. **GivEnergy AIO Product Page** — GivEnergy All-In-One specifications and UK pricing: [givenergy.co.uk](https://www.givenergy.co.uk)
5. **NREL — Residential Battery Storage Overview** — National Renewable Energy Laboratory background on residential battery performance benchmarks: [nrel.gov/solar/batteries](https://www.nrel.gov/solar/batteries.html)
6. **NEC Article 706 — Energy Storage Systems** — National Electrical Code requirements for stationary energy storage installations (US): [nfpa.org/codes-and-standards/70](https://www.nfpa.org/codes-and-standards/70)
