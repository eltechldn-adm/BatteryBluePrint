...
**Scenario:** A hypothetical homeowner in Victoria, British Columbia installs a 5.5 kW solar array + Tesla Powerwall 3 (13.5 kWh) in March 2026. *This is a modelled scenario illustrating market economics, not a documented outcome.*
...
- CSA C22.2 No. 107.1 certification: Tesla Powerwall 3 — assumed certified

**Incentive stack:**
- BC Hydro CleanBC battery rebate: **CAD $5,000** (assumed pre-installation — written approval modelled)
...
1. Confirm CSA C22.2 No. 107.1 certification for the specific battery and inverter model being installed
2. Request the cold-temperature capacity derating curve from the manufacturer — for systems in areas with winter temperatures below -10°C, size the battery for winter-derated capacity, not nameplate
3. For IESO demand response enrolment (Ontario), confirm DRaaS API compatibility with the specific battery brand before signing the installer contract
4. Obtain BC Hydro rebate pre-approval in writing before authorising installation — post-installation applications have been declined in previous programme periods
...
**The key decision trigger** for Canadian homeowners is the provincial electricity rate combined with rebate access. Use the [battery sizing calculator](/calculator) with your actual rate schedule and the confirmed rebate quantum, and target a net-of-rebate payback below 12 years as the minimum threshold for a financially justified investment.
...
1. **Natural Resources Canada (NRCan)** — Official Greener Homes program data and energy statistics: [nrcan.gc.ca](https://www.nrcan.gc.ca/)
1. **Canada Energy Regulator (CER)** — Canada's energy future reports and provincial cost variations: [cer-rec.gc.ca](https://www.cer-rec.gc.ca/)
1. **BC Hydro Net Metering** — Provincial guidelines influencing battery adoption in British Columbia: [bchydro.com](https://www.bchydro.com/)
1. **Efficiency Nova Scotia** — Provincial rebate and energy storage guidelines: [efficiencyns.ca](https://www.efficiencyns.ca/)
...
- [Solar Battery Payback Reality: UK vs US vs Global](/payback-reality) — How Canadian markets compare globally
- [Biggest Mistakes Homeowners Make with Solar Batteries](/common-mistakes) — Canada-specific planning errors
- [When NOT to Buy a Solar Battery](/when-not-to-buy) — When Canadian electricity rates make storage unviable
