...
- Austin Energy net metering: Modelled at historical 1:1 retail rate equivalent.
- Export cap: Full production permitted (no modelled export limit)
- Interconnection timeline: 3 weeks (modelled fast-track assumption)

**Incentive stack:**
- Federal ITC: $0 (Not available for 2026 purchases; Section 25D expired December 2025)
- Texas state incentive: None
- Austin Energy rebate: $2,500 (Austin Energy Residential Solar Program — modelled assumption based on historical rates)

**Net cost calculation:**
- Gross battery system cost (2x Powerwall 3): $23,000 (incremental investment for storage only)
- Austin Energy battery rebate: -$2,500 (modelled assumption based on historical rate)
- Federal ITC: $0 (Expired for 2026)
- Net incremental cost for storage: **$20,500**
...
- Grid export: 3,020 kWh/year (16,020 - 5,500 - 7,500)
- Grid import: 1,750 kWh/year (14,000 - 5,500 - 6,750)

**Financial performance (Battery incremental value):**
- The battery delivers 6,750 kWh/year to avoid peak/evening grid imports.
- Total annual saving from battery: 6,750 kWh × $0.12 = **$810/year**
- *Note: This assumes a tariff structure where avoided import provides a $0.12/kWh advantage over export.*

**Payback: $20,500 ÷ $810 = 25.3 years**

**Lesson:** Texas's lack of state incentives and Austin's moderate rate ($0.12/kWh) produce a longer payback than the California comparison case, especially with the expiration of the federal ITC. The resilience value of 27 kWh during potential grid stress events is the primary non-financial driver for the modelled decision. Use the US battery sizing calculator and [US state incentives guide](/incentives/us-state-solar-battery-rebates-guide-2026) to model your specific state and utility scenario.
