...
- Net out-of-pocket: $28,500 – $2,500 = **$26,000**
...
**Payback: $26,000 ÷ $1,094 = 23.8 years**

**Lesson:** Texas's lack of state incentives and Austin's moderate rate ($0.12/kWh) produce a longer payback than the California comparison case, especially with the expiration of the federal ITC. The resilience value of 27 kWh during Texas grid stress events (approximately 4–8 multi-hour events per year) was the primary non-financial driver for the modelled decision. Use the US battery sizing calculator and [US state incentives guide](/incentives/us-state-solar-battery-rebates-guide-2026) to model your specific state and utility scenario.
