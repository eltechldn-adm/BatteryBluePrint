...
- Tariff structure: Value of Solar (VoS) credit at 9.91 cents/kWh for residential customers. Austin Energy credits 100% of metered solar production at the VoS rate, regardless of self-consumption.
...
- Because Austin Energy credits 100% of solar production at the VoS rate (9.91 cents/kWh) rather than allowing standard net metering, the battery does not provide the traditional financial arbitrage value of shifting solar consumption to offset high import rates. 
- You earn the same credit for your solar energy whether you use it directly, store it, or export it immediately.
- Therefore, the primary driver for adding a battery in this utility territory is resilience and backup power during grid outages, rather than a quantifiable financial payback.

**Lesson:** In Austin, the Value of Solar (VoS) tariff pays a fixed rate for all solar production. With no battery-specific rebates and the expiration of the federal ITC, the incremental financial payback for adding a battery is difficult to justify on economics alone. The resilience value of 27 kWh during potential grid stress events is the almost exclusive driver for the modelled decision. Use the US battery sizing calculator and [US state incentives guide](/incentives/us-state-solar-battery-rebates-guide-2026) to model your specific state and utility scenario.
