...
## Federal Incentive: Cheaper Home Batteries Programme

Australia introduced the **Cheaper Home Batteries Programme** in 2024, which expanded the Small-scale Renewable Energy Scheme (SRES) to include residential batteries. This is the primary federal incentive active as of August 2026.

**How it works:**
- Creates Small-scale Technology Certificates (STCs) for eligible battery systems (5–100 kWh nominal capacity)
- Your installer typically claims the STCs and applies the value as an upfront discount on your quote
- The programme is designed to provide around a 30% discount for a range of eligible battery sizes, but the actual value varies with usable capacity, the applicable STC factor, system size and STC market value.
- The incentive value steps down every six months — next adjustment scheduled January 2027

**State programmes** add on top of the federal incentive, though availability varies significantly:

### Victoria Solar Battery Rebate

**August 2026 status: Victorian state battery rebate and loan programmes are closed to new applications.** The Solar Homes programme currently provides rebates for solar panels (PV) only in Victoria. Check [solar.vic.gov.au](https://www.solar.vic.gov.au) for current programme status before making installation decisions.

Historical rebate (for reference — no longer available for new applications):
- Combined household income <$180,000/year
- Property value <$3 million
- Must use Solar Victoria-approved installer

### South Australia Home Battery Scheme

**August 2026 status: The SA Home Battery Scheme is permanently closed.** It ceased operations in 2022. No state battery subsidy is currently available in South Australia. VPP incentives through retailers remain available under the Retailer Energy Productivity Scheme (REPS). Contact SA Power Networks or your energy retailer for current VPP programme terms.
...
**Rental properties and state rebate access.** Most Australian state battery programmes are (or were) limited to owner-occupiers or have consent requirements for renters. With Victoria's battery programme now closed and SA's permanently closed, the primary incentive pathways in 2026 are the federal Cheaper Home Batteries programme (STC-based discount applied at point of sale by eligible installers) and VPP enrolment. Renters can potentially benefit from VPP programmes if the landlord consents to battery installation and VPP enrolment, but obtaining and documenting that consent before commissioning is essential.
...
**Incentive stack:**
- SA Home Battery Scheme: **Permanently closed** (ceased 2022 — no rebate available)
...
**Lesson:** The export limit constraint cost approximately AUD $90/year compared to the unconstrained case. The more significant real-world adjustment was ensuring the Sungrow system was correctly registered on the SA Power Networks DER register before commissioning — without this, the installation would not have received network connection approval. Use the battery sizing calculator and our [Australian incentives guide](/incentives/australia-solar-battery-rebates-incentives-2026) to model your specific state and circuit situation.
...
1. **AEMO (Australian Energy Market Operator)** — Data on residential battery uptake and grid impacts: [aemo.com.au](https://aemo.com.au/)
1. **Clean Energy Council (CEC)** — Solar and battery market reports for Australia: [cleanenergycouncil.org.au](https://www.cleanenergycouncil.org.au/)
1. **Sunwiz** — Independent market analysis of Australian solar battery sales and pricing: [sunwiz.com.au](https://www.sunwiz.com.au/)
1. **Australian Energy Regulator (AER)** — Retail electricity price monitoring: [aer.gov.au](https://www.aer.gov.au/)
