...
**Scenario:** A hypothetical homeowner in Munich, Bavaria installs a 7 kW solar array + BYD Battery-Box Premium HVS 10.2 kWh in April 2026. *This is a modelled scenario illustrating market economics, not a documented outcome.*
...
- KfW 442 (assumed active on day of application): **€3,200 grant**
...
1. **European Commission EU Battery Regulation** — Sustainability, recycling, and safety requirements for batteries in the EU: [environment.ec.europa.eu](https://environment.ec.europa.eu/topics/waste-and-recycling/batteries_en)
1. **JRC PVGIS Tool** — Official EU Joint Research Centre tool for estimating solar and storage performance: [re.jrc.ec.europa.eu/pvg_tools](https://re.jrc.ec.europa.eu/pvg_tools/en/)
1. **SolarPower Europe** — European Market Outlook for Residential Battery Storage: [solarpowereurope.org](https://www.solarpowereurope.org/)
1. **Eurostat** — Electricity price statistics for household consumers across the EU: [ec.europa.eu/eurostat](https://ec.europa.eu/eurostat/)
