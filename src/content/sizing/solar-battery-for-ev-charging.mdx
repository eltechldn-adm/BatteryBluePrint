...
<DocsFAQ>
    ...
    **Vehicle-to-Home (V2H)** is the ultimate goal. A Ford F-150 Lightning has a 130 kWh battery—equal to 10 Tesla Powerwalls.
...
**Scenario:** A hypothetical household in Surrey, UK has a 6 kW solar array and a Nissan Leaf (40 kWh battery, averaging 35 miles daily commute). They install a Zappi EV charger in April 2025 to solar-charge their EV. First 4 months (April–July 2025):
...
**Lesson:** The solar-direct EV charging benefit is real but seasonal and often secondary to the off-peak scheduling capability. Model both separately before committing to the solar-aware charger specification. Use the [battery sizing calculator](/calculator) to determine whether the EV load should be routed through the home battery or handled by a dedicated scheduled charger, and see our [solar battery cost guide](/markets/uk-solar-battery-cost-2026) for current system cost benchmarks.
...
1. **US Department of Transportation** — Average daily driving distances and EV efficiency data: [fhwa.dot.gov](https://www.fhwa.dot.gov/)
1. **EPA Fuel Economy Ratings** — Official kWh/100 miles efficiency ratings for electric vehicles: [fueleconomy.gov](https://www.fueleconomy.gov/)
1. **IEA Global EV Outlook** — Energy consumption patterns for residential EV charging: [iea.org/reports/global-ev-outlook](https://www.iea.org/reports/global-ev-outlook)
1. **Tesla Wall Connector Specs** — Technical requirements for integrating residential EV charging with storage: [tesla.com](https://www.tesla.com/)
