...
**Lesson:** Always request winter-specific (December) solar irradiance figures from your installer — not annual or autumn averages. Use the [battery sizing calculator](/calculator) to input your postcode and see month-specific generation estimates before committing to a system size.
...
- [How Much Battery Storage Do I Need?](/sizing/how-much-battery-storage-do-i-need) — The three-archetype sizing framework
- [UK Solar Battery Incentives 2026](/cost/uk-solar-battery-incentives) — How incentives reduce the cost of the correctly-sized system
