...
**US update (August 2026):** The Section 25D residential ITC was terminated for installations placed in service after December 31, 2025. There is no federal residential battery credit for 2026 purchases. State-level rebates (like California SGIP, now on waitlist/closed) are also tightening. The UK's 0% VAT is confirmed until March 2027. For US buyers, acting on state incentives before they close is now the primary timing consideration.
...
1. **EIA SAIDI Reliability Data** — System Average Interruption Duration Index data used to value resilience: [eia.gov](https://www.eia.gov/)
1. **NREL Value of Solar** — Research on the economic value of distributed solar and storage to homeowners: [nrel.gov](https://www.nrel.gov/)
1. **Lawrence Berkeley National Laboratory** — Studies on home value premiums for properties with solar and storage: [emp.lbl.gov](https://emp.lbl.gov/)
1. **Ofgem Tariff Data** — Agile and time-of-use tariff rate variability driving battery arbitrage value: [ofgem.gov.uk](https://www.ofgem.gov.uk/)
