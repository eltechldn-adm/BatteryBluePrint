...
<div className="space-y-4">
  <details className="group border rounded-lg bg-card p-4 [&_summary]:cursor-pointer">
    ...
    <div className="text-muted-foreground mt-4 leading-relaxed">
      Not entirely. Lithium retains an energy density advantage for weight-sensitive applications (sports cars, long-range EVs, smartphones). Sodium is emerging as the lower-cost option for stationary bulk storage (grid farms, home backup, budget EVs) where weight is not a constraint.
    </div>
  </details>
  ...
  <details className="group border rounded-lg bg-card p-4 [&_summary]:cursor-pointer">
    ...
    <div className="text-muted-foreground mt-4 leading-relaxed">
      As of 2025, **CATL** (China) is the largest producer of sodium-ion cells by volume. In the US, **Natron Energy** makes a "Prussian Blue" sodium battery rated for 50,000 cycles, but it is currently targeted at data centers rather than residential installations.
    </div>
  </details>
...
**Scenario:** A hypothetical technology-aware homeowner in Sheffield evaluates in Q1 2026 whether to install a current LFP battery or wait for sodium-ion alternatives. *This is a modelled scenario illustrating market economics, not a documented outcome.*
...
The model suggests installing LFP immediately. The approximately £1,430 net financial advantage of buying now versus waiting (under these projections) outweighs the technology novelty appeal of being an early sodium-ion adopter.

**Lesson:** For financially motivated battery decisions, the opportunity cost of waiting for emerging technology is concrete and quantifiable. Use the [battery sizing calculator](/calculator) and [UK cost guide](/markets/uk-solar-battery-cost-2026) to run the numbers for your specific situation before making a timing decision.
