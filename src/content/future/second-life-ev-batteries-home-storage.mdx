...
### 1. Nissan Leaf (Most Accessible for Retrofit)
*   **Chemistry**: LMO / NMC.
...
*   **[Battery Fire Safety Guide](/guide)**
...
**Scenario:** A hypothetical commercial property manager in Manchester considers second-life battery storage for a 50 kW solar installation on a warehouse in 2026 versus new LFP. *This is a modelled scenario illustrating market economics, not a documented outcome.*
...
**Modelled Decision:** The model recommends new LFP at effectively identical installed pricing, with a materially superior warranty package. The second-life option was not cheaper after accounting for integration costs, and carried meaningfully less warranty protection.
...
**Lesson:** Second-life economics improve significantly at scale. At residential scale (9.5–27 kWh), the integration cost per kWh is disproportionately large. At commercial and grid scale (500 kWh+), the per-kWh integration cost amortises across a larger capacity base and the price gap to new becomes genuinely compelling. Review new LFP options at [current pricing](/markets/uk-solar-battery-cost-2026) as the correct comparison baseline for residential applications in 2026.
