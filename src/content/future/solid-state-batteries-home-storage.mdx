...
Companies like Enphase have solid-state units on their residential roadmaps for 2026/2027.

But in early 2026, you cannot walk into a hardware store and buy one. Why?
...
*   **The Risk**: That liquid electrolyte is an organic solvent. It is flammable. If the battery overheats, the liquid can evaporate, build pressure, and in worst-case scenarios contribute to thermal runaway and fire.
...
*   **Likely Winner For**: **Home Storage**. Companies like Enphase are targeting solid polymer or composite electrolytes for their upcoming residential solid-state batteries, rather than the pure ceramic or sulfide structures used in EV research.
...
### 2030+: Mass Adoption
*   **Scale**: This is when SSB manufacturing yield is expected to mature.
*   **Home Storage**: You will see wider availability, but they will still launch at a premium price per kWh compared to mature LFP technology. They will not halve the cost of home storage on day one.
...
<div className="space-y-4">
  <details className="group border rounded-lg bg-card p-4 [&_summary]:cursor-pointer">
    ...
    <div className="text-muted-foreground mt-4 leading-relaxed">
      **Safety and Density.** Current LFP batteries last 15+ years and are very safe, but SSBs offer a reduced risk of thermal runaway and potentially longer lifespans because there is no liquid to degrade. They also take up much less space, which is great for tight installations.
    </div>
  </details>
  ...
  <details className="group border rounded-lg bg-card p-4 [&_summary]:cursor-pointer">
    ...
    <div className="text-muted-foreground mt-4 leading-relaxed">
      **No, not initially.** Solid-state residential batteries will launch at a premium price per kWh compared to mature LFP technology. While they use fewer materials, manufacturing them requires expensive new factories. Until those factories scale up, SSBs will be a premium product.
    </div>
  </details>
</div>
...
*   **Industry Development Example**: The **NIO ET7** (Chinese EV) is currently shipping with a 150 kWh Semi-Solid pack from **WeLion**. It has a CLTC laboratory-rated range of 1,000 km.
...
| **Solid State** | Ceramic / Polymer | **High** | **Significantly Reduced Risk** |

**The Conclusion**: A solid-state battery significantly mitigates the risk of catastrophic thermal runaway compared to early NMC liquid lithium-ion, making it an extremely safe choice for home integration, though it does not completely eliminate all risks inherent to energy storage.
...
**Scenario:** The engineering design lead of a UK new-build development (50 units, planning submission 2026, expected completion 2028) must specify home battery infrastructure for all units. *This is a modelled scenario illustrating market economics, not a documented outcome.*
...
**Modelled Decision:** Under these assumptions, the model favours Option B at a £380/unit premium across 50 units = £19,000 total. The modelled reasoning: if solid-state products delivering 20+ kWh in the current LFP form factor become available by 2030, retrofitting a second storage unit to units built with Option A specification would cost £1,200–£1,800 per unit in additional electrical work. The £380 premium now models the prevention of a much larger future cost.
...
**The key decision trigger** for any technology-timing decision remains a financial rather than technological question: does the available technology at today's prices deliver a financially justified outcome at current tariff rates? If yes, install now. If the technology case is marginal, track the market through a [current UK cost guide](/markets/uk-solar-battery-cost-2026) review and use the [battery sizing calculator](/calculator) to confirm the specific numbers for your installation.
