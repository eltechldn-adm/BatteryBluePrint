...
*Note: The Section 25D residential federal ITC expired for systems placed in service after December 2025. The following scenarios reflect 2026 costs without federal credit. These are illustrative planning examples using representative 2026 hardware and tariff assumptions.*

### Scenario A: Solar Only ($20,000 System)
*   **System**: 6 kW Solar.
*   **Cost**: $20,000.
*   **Federal ITC**: Not available for 2026 purchases (Section 25D expired December 2025).
*   **Net Cost**: $20,000.
*   **Annual Bill Savings**: ~$1,200 (Most exports are worthless under NEM 3.0).
*   **Illustrative NEM 3.0 Payback**: **~16.7 Years**.
...
*   **Illustrative NEM 3.0 Payback**: **10.0 Years**.

**Comparison**: Adding a battery increases upfront cost by $15k, but reduces the illustrative payback period by approximately 6.7 years compared to going solar-only under NEM 3.0. The battery captures evening peak-rate value that solar-only systems lose under NEM 3.0's low export rate structure. Use the [calculator](/calculator) to model your specific system size and tariff assumptions.
...
**Scenario:** Two adjacent homes in Fresno, California — both PG&E customers — install 7.5 kW solar systems and 13.5 kWh Tesla Powerwall 3 batteries in October 2025 (post-NEM 3.0 implementation). *This is a modelled scenario illustrating market economics, not a documented outcome.*
...
**Lesson:** NEM 3.0 makes panel orientation a financial decision, not just an aesthetic one. South-facing maximises total generation but concentrates it in low-ACC-value midday hours. East-west orientation reduces midday overproduction and increases morning and evening generation that aligns better with ACC peak rate windows. Use the NEM 3.0 payback calculator and [SGIP rebate guide](/incentives/sgip-rebate-guide-california) to model both orientations before committing to panel placement.
...
1. **CPUC NEM 3.0 Ruling** — Official regulatory text for the Net Billing Tariff (NEM 3.0): [cpuc.ca.gov/nem](https://www.cpuc.ca.gov/nem)
1. **SEIA NEM 3.0 Factsheet** — Solar Energy Industries Association analysis on export rates: [seia.org](https://www.seia.org/)
1. **NREL Avoided Cost Calculator** — Methodology for determining the value of exported energy: [nrel.gov](https://www.nrel.gov/)
1. **California ISO (CAISO)** — Grid demand curves reflecting the 'duck curve' driving NEM changes: [caiso.com](https://www.caiso.com/)
