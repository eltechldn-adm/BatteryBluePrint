...
**Scenario:** A hypothetical homeowner in York checks three shortlisted installers using the steps in this article (February 2026):
...
**Modelled Verification Finding:** Installer C's trading name differed from the Companies House filing, and their PLI certificate had lapsed. This combination — unclear corporate identity, expired insurance, and no certification — is the profile of a business operating outside the standards required for legitimate MCS work. The model eliminates Installer C immediately.

**Modelled Decision:** The model selects Installer A. The longer MCS track record, validated insurance, and reviews volume make it the lowest-risk choice despite being priced £450 above Installer B.

**Lesson:** The verification process identified a non-compliant contractor that a homeowner who only checked TrustMark status would have missed. MCS database, Companies House, and insurance validation together take approximately 30 minutes and provide materially better protection than a single certification check. Use the steps in this guide before accepting any quote, and compare pricing benchmarks using the [UK battery cost guide](/markets/uk-solar-battery-cost-2026) to confirm quotes are within expected range.
...
1. **NABCEP** — Gold standard for US solar and storage installation certification: [nabcep.org](https://www.nabcep.org/)
1. **MCS (UK)** — Mandatory certification scheme for accessing UK export tariffs: [mcscertified.com](https://mcscertified.com/)
1. **OSHA Construction Standards** — Electrical safety requirements for residential installations: [osha.gov](https://www.osha.gov/)
1. **UL Standards (UL 9540)** — Safety certification for energy storage systems: [ul.com](https://www.ul.com/)
