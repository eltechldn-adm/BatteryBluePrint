export function getBlueprintEmailHTML(downloadUrl: string, recipientName?: string): string {
        ...
        <table width="100%" style="max-width: 600px; background-color: #FFFFFF; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #FAF8F5 0%, #F5E6D3 100%); padding: 40px 40px 30px; text-align: center; border-bottom: 2px solid #E35336;">
              ...
              <p style="margin: 8px 0 0; font-size: 14px; color: #6B5B4D;">
                Engineering-Grade Solar Battery Sizing
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.6; color: #3D3226;">
                Thank you for confirming your email! Your custom battery sizing PDF is ready to download.
              </p>

              <p style="margin: 0 0 30px; font-size: 16px; line-height: 1.6; color: #3D3226;">
                Click the button below to download your blueprint:
              </p>
              ...
              <p style="margin: 30px 0 20px; font-size: 14px; line-height: 1.6; color: #6B5B4D; padding: 16px; background-color: #FEF3EF; border-left: 3px solid #E35336; border-radius: 4px;">
                <strong>Important reminder:</strong> BatteryBlueprint is a planning tool, not professional engineering advice. For installation, permitting, and final system design, please work with a licensed electrician or solar installer.
              </p>

              <p style="margin: 0 0 15px; font-size: 16px; line-height: 1.6; color: #3D3226;">
                Want to re-run the calculator with different inputs? Visit us anytime at 
                <a href="${process.env.NEXT_PUBLIC_SITE_URL || 'https://batteryblueprint.com'}/calculator" 
                   style="color: #E35336; text-decoration: none; font-weight: 500;">BatteryBlueprint.com</a>
              </p>

              <p style="margin: 0; font-size: 14px; line-height: 1.6; color: #6B5B4D;">
...
export function getBlueprintEmailText(downloadUrl: string, recipientName?: string): string {
    const greeting = recipientName ? `Hi ${recipientName}` : 'Hi there';
...
IMPORTANT REMINDER: BatteryBlueprint is a planning tool, not professional engineering advice. For installation, permitting, and final system design, please work with a licensed electrician or solar installer.

Want to re-run the calculator? Visit: ${process.env.NEXT_PUBLIC_SITE_URL || 'https://batteryblueprint.com'}/calculator
